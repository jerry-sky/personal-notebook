...
$APTI "git"
# configure git
printf "\033[1mConfiguring…\033[0m\n"
...
printf "Now, we can download a private repository so Git can ask you for your password. However, instead of your password provide a newly generated GitHub access token that you can attain here: https://github.com/settings/tokens/new"
git clone 'https://github.com/jerry-sky/personal-notebook-private'
printf "\033[1mRemember to add commit and tag signing after you regain access to your GPG keys."

# download Chrome
printf "\033[1mGoogle Chrome Stable\nDownloading…\033[0m\n"
...
printf "\033[1mDownloading the notebook repositories…\033[0m\n"
cd "~/notebooks"
